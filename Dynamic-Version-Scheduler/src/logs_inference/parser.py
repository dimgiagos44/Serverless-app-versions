...
reward_str = '/home/dgiagos/openfaas/Serverless-app-versions/Dynamic-Version-Scheduler/src/logs_inference/'
reward_str2 = 'logs_fullmap/reward_log2.log'
time_str = '/home/dgiagos/openfaas/Serverless-app-versions/Dynamic-Version-Scheduler/src/logs_inference/'
time_str2 = 'logs_fullmap/time_log2.log'
action_str = '/home/dgiagos/openfaas/Serverless-app-versions/Dynamic-Version-Scheduler/src/logs_inference/'
action_str2 = 'logs_fullmap/action_log2.log'
...
def mergeResults(c,):
    if c == 't':
        time_data = []
        times = open(time_str + time_str2, 'r')
        ...
        action_data = []
        actions = open(action_str + action_str2, 'r')
        ...
        reward_data = []
        rewards = open(reward_str + reward_str2, 'r')
...
action = mergeResults('a', )
action2 = parseActions(action)

reward = mergeResults('r', )
...
plt.show()
plt.savefig('../../images/fullmap_inference.png')